...
def game():
    ...
    #输入校验,插入历史列表
    def run_step():
        global num_inside,num_input,level,run_history,list_history,run_button,run_entry,entry_game,num,gamedate
            ...
            if check(num,str(entry_game.get())):
                ...
                def date1():
                    ...
                    if num-1==0:
                        ...
                        gamedate.date[num-1][3].append(int(A[0])+int(A[1]))
                        pass
                    else:
                        A=gamedate.date[num-1][1][2].split(' ')
                        ...
                        if C_1<0:
                            gamedate.date[num-1][3].append(source-C_1)
                        else:
...
#重新开始
def restart():
    global xgame,list_frame,num_inside
    if xgame==True:
        frame_game.destroy()
        list_frame.remove(frame_game)
        game()
